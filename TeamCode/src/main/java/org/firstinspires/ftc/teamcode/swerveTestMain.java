...
@TeleOp(name = "swerveTestMain", group = "TeleOp2024")
public class swerveTestMain extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        DcMotor linSlideL=  hardwareMap.get(DcMotor.class, "linSlideL");
        DcMotor linSlideR = hardwareMap.get(DcMotor.class, "linSlideR");
        ServoImplEx intakeArmServo = hardwareMap.get(ServoImplEx.class, "intakeArmServo");
        PwmControl.PwmRange armRange = new PwmControl.PwmRange(1000, 2000);

        intakeArmServo.setPwmRange(armRange);
        Servo intakeWristServo = hardwareMap.get(Servo.class, "intakeWristServo");
        Servo intakeServo = hardwareMap.get(Servo.class, "intakeServo");
        Servo clawServo = hardwareMap.get(Servo.class, "clawServo");
        Servo clawWristServo = hardwareMap.get(Servo.class, "clawWristServo");
