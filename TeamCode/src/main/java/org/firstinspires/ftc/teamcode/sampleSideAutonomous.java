...
@Autonomous(name="sampleSide", group="Auto2024")
...
//            driveForward(0.2, angleWrap(odo.getHeading()));
            while (true) {
                ...
                odo.bulkUpdate();
                driveForwardCorrection(angle, 0.6, 600, pos.getPosition().x);
